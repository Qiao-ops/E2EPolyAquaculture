...
def read_multichannel_tif_in_blocks(path, block_size=512):
    # 读取多通道TIF图像，并分块处理
    dataset = gdal.Open(path)
...
def generate_semantic_segmentation_dataset(image_path, shapefile_path, category_mapping, output_dir, tile_size=512, overlap=0):
