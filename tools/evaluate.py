...
def single_annotation(image_id, poly, bbox, score):
    ...
    annotation = {
        ...
        "category_id": 1,  # Fixed category ID for buildings
        "score": score,
        "segmentation": poly,
        "bbox": bbox_xywh
    }
...
if __name__ == '__main__':
    register_my_dataset(dataset_name="lyg_test",
                        TEST_JSON="/qiaowenjiao/HiSup/data/yangzhiqu/lyg_3/cut_300/val/annotation_new.json",
                        TEST_PATH="/qiaowenjiao/HiSup/data/yangzhiqu/lyg_3/cut_300/val/images")
    main()
