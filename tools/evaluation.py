...
from tools.boundary_iou.coco_instance_api.coco import COCO as BCOCO
# HiSup/tools/boundary-iou-master/boundary_iou/coco_instance_api/coco.py
from tools.boundary_iou.coco_instance_api.cocoeval import COCOeval as BCOCOeval
...
# python tools/evaluation.py --gt-file  /qiaowenjiao/HiSup/data/yangzhiqu/lyg_3/cut_300/val/annotation_new.json --dt-file /qiaowenjiao/HiSup/outputs/lyg_hrnet48/lyg_test.json --eval-type boundary_iou